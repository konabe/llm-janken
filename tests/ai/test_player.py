...
class TestAIPlayer(unittest.TestCase):
    ...
    def test_record_game(self):
        ...
        self.assertEqual(self.ai_player.game_history[0], (Choice.ROCK, Choice.SCISSORS, "win"))
...
class TestPatternAIPlayer(unittest.TestCase):
    ...
    @patch('random.random')
    @patch('random.choice')
    def test_make_choice_pattern_learning_counter(self, mock_random_choice, mock_random):
        """パターン学習での対策選択テスト"""
        # 70%の確率で対策を選択するよう設定
